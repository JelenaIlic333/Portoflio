...
const Contact = () => {
   ...
   const onSubmit = async (event) => {
    ...
    formData.append("access_key", "06ffe339-6dc3-473c-8772-28e6e8f542c7");
  ...
  return (
    ...
    dark:bg-none'>
        ...
        <motion.h4
         ...
         className='text-center mb-2 text-lg font-Ovo'>Connect wiht me
         </motion.h4>
        ...
        <motion.h2
         ...
         className='text-center text-5xl font-Ovo'>Get in touch
         </motion.h2>
      ...
      <motion.form
       ...
       onSubmit={onSubmit} className='max-w-2x1 mx-auto'> 
